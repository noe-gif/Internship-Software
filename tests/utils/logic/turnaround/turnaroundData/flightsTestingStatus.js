export const inProgressArrivalOnlyTurnaround = {
  status: {
  ...
  arrival_flight: {
    ...
    estimated_gate_departure_datetime: null,
...
export const completedDepartureOnlyTurnaround = {
  status: {
    category: "completed"
  },
  all_doors_closed_target_datetime: "2021-06-14T11:55:00Z",
  departure_flight: {
    actual_gate_arrival_datetime: null,
    actual_gate_departure_datetime: "2021-06-14T11:55:00Z",
    actual_runway_arrival_datetime: null,
    actual_runway_departure_datetime: null,
    aircraft: {
      tail_number: "FHZEN",
...
export const incomingTurnaround = {
  status: {
    category: "incoming"
  },
  all_doors_closed_target_datetime: "2021-06-14T12:00:00Z",
  departure_flight: {
    actual_gate_arrival_datetime: null,
    actual_gate_departure_datetime: "2021-06-15T10:59:00Z",
    actual_runway_arrival_datetime: null,
    actual_runway_departure_datetime: null,
    aircraft: {
      tail_number: "FHZEN",
  ...
  arrival_flight: {
    actual_gate_arrival_datetime: "2021-06-13T18:20:00Z",
    actual_gate_departure_datetime: null,
    actual_runway_arrival_datetime: null,
    actual_runway_departure_datetime: null,
    aircraft: {
